...
> 当前版本 **v5.6「家园精修」** — R 键改为道具径向转盘（最多 6 格均布、鼠标点选、打开暂停）、远征消耗品（含火把）最多携带 6 种每种 5 个、火把单支限时燃烧且耗尽自动续燃、新增普通作物火绒草（收获产火把×2）、准备大厅取消强化卡临选改为卡牌工坊永久升级、强化卡 5 合 1 合成（普通→稀有→传说/重铸）、家园指挥台一键种植/收成熟/除害并删除微缩格子、农场雨/雷暴全屏斜纹柔化去模糊、技能卡中文效果标签修复；数值表升级为 25 sheet《游戏数据表_v5.6.xlsx》。
> 上一版本 **v5.5「家园联动」** — 加工工坊成品全部接入远征消耗品、火把照明按难度分级且无火把视野极小、农场实时家园指挥台、美观度增益显性化、天气屏幕特效、撤离卡死修复、边界迷雾裁剪；v5.4「荒野校准」：难度两维重做、12 Boss 软狂暴、兽潮指数化、千局 bot 校准、经济闭环 7 次撤离满级；v5.0「荒野觉醒」：100 级修行台 × 16 技能 × 远征档案 × 14 种具体资源 × 12 Boss/24 地图 × 105 张统一写实图标
